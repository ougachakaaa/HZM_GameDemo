...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        //camera rotate
        [Range(0.0f, 1f)] public float normalRotateSensitivity;
        [Range(0.0f, 1f)] public float aimingRotateSensitivity;
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                SetRotateSensitivity(_input.aim);

                _cinemachineTargetYaw += _input.look.x * deltaTimeMultiplier * _rotateSensitivity;
                _cinemachineTargetPitch += _input.look.y * deltaTimeMultiplier* _rotateSensitivity;
            }
        ...
        private void Move()
        {
            ...
            // move the player
            _controller.Move(targetDirection.normalized * (_speed * Time.deltaTime) + knockBackVelocity*Time.deltaTime+
        ...
        public void SetRotateSensitivity(bool isAiming)
        {
            _rotateSensitivity = isAiming ? aimingRotateSensitivity : normalRotateSensitivity;
        }
